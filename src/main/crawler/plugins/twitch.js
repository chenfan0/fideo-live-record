...
const log = debug('fideo-live-stream-getTwitchLiveUrl')

export async function getTwitchLiveUrl(roomId, others = {}) {
  const { proxy, cookie } = others

  log('getTwitchUrl start: ', roomId, cookie, proxy)
  ...
  try {
    ...
    log('getTwitchLiveUrl error: ', errMsg)
